...
class StackEncoder(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.convr1 = ConvBnRelu(in_channels, out_channels, kernel_size=(3, 3), stride=1, padding=0) #no padding 
...
class UNetOriginal(nn.Module):
    def __init__(self, in_shape):
        ...
        self.down1 = StackEncoder(channels, 64) #3 -> 64 -> 64
        self.down2 = StackEncoder(64, 128) #64 -> 128 -> 128 
        self.down3 = StackEncoder(128, 256) #128 -> 256 -> 256 
        self.down4 = StackEncoder(256, 512) #256 -> 512 -> 512

        # the last layer is without pooling 
        self.center = nn.Sequential(
            ConvBnRelu(512, 1024, kernel_size=(3, 3), stride=1, padding=0),
            ConvBnRelu(1024, 1024, kernel_size=(3, 3), stride=1, padding=0)
        )

        self.up1 = StackDecoder(in_channels=1024, out_channels=512, upsample_size=(48, 48))
        self.up2 = StackDecoder(in_channels=512, out_channels=256, upsample_size=(88, 88))
        self.up3 = StackDecoder(in_channels=256, out_channels=128, upsample_size=(168, 168))
        self.up4 = StackDecoder(in_channels=128, out_channels=64, upsample_size=(328, 328))
